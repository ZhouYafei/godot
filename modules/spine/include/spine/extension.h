...
#define MALLOC(TYPE,COUNT) (COUNT==0?NULL:((TYPE*)_malloc(sizeof(TYPE) * (COUNT), __FILE__, __LINE__)))
#define CALLOC(TYPE,COUNT) (COUNT==0?NULL:((TYPE*)_calloc(COUNT, sizeof(TYPE), __FILE__, __LINE__)))
...
#define FREE(VALUE) if(VALUE!=NULL)_free((void*)VALUE)
