...
env_base.__class__.android_add_to_launcher = methods.android_add_to_launcher
env_base.__class__.android_add_to_metadata = methods.android_add_to_metadata
...
opts.Add('squish','Squish BC(dds) Texture Compression/Decompression(yes/no)','yes')
